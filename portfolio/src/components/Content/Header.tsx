...
const Header: React.FC<ActiveSectionProps & HeaderProps> = ({ activeSection, showNavSection }) => {
  ...
  return (
    <div className="header lg:w-1/3 lg:py-24 lg:mr-10 lg:max-h-screen overflow-y-auto sticky top-0 min-w-92 flex-none flex flex-col justify-between z-50">
      ...
      <p className="flex-wrap hidden md:flex max-w-sm text-slate-400 text-sm">Software engineer and 7-year United States Air Force veteran who transitioned from defense IT operations to full-stack development. After managing classified networks and coordinating deployment operations for 170+ personnel, I earned my Software Engineering degree from Arizona State University and dove into building modern applications. I specialize in Rust, C#/.NET, React, and TypeScript, with experience spanning NASA mission software, encrypted cloud storage systems, and accessibility-focused kiosk applications deployed with Kubernetes and Docker. I've also published open-source libraries on crates.io, including Logfather and Dekor (see projects). I bring military-grade discipline to solving complex problems, with a focus on security, performance, and creating tools that empower developers.</p>
